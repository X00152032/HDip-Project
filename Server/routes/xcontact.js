...
app.use(express.static(path.join(__dirname, "src/views/contact")));
...
app.post("/contact", function(request, response) {
  // create reusable transporter object using the default SMTP transport
	const transporter = nodemailer.createTransport({
		...
		secure: true,
		auth: {
			user: "straphaelasschool@gmail.com", // this should be YOUR GMAIL account
			pass: "Password2020!" // this should be your password
		}
	});
	...
	var mail = {
		from: "straphaelasschool@gmail.com", // sender address
		to: "straphaelasschool@gmail.com", // list of receivers (THIS COULD BE A DIFFERENT ADDRESS or ADDRESSES SEPARATED BY COMMAS)
