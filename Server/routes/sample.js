...
const SQL_SELECT_ALL = 'SELECT * FROM dbo.Sample';
// without_array_wrapper - use for single result

const SQL_SELECT_BY_ID = 'SELECT * FROM dbo.Sample WHERE id = @id for json path, without_array_wrapper;';


//Not used for sample but will be for full working assessment - work in progress
 ...
 * Address http://server:port/sample/:id
