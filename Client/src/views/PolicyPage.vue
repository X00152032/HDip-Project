...
<template>
  <div class="policy container-fluid">
    <div id = maintable class="bg-white text-grey" style="text-align: left"> <!--format table-->
        ...
        <h3></h3>
  <div class="image">
            <img alt="Privacy Policy" src="../assets/privacy_policy.jpg">
  </div>

<div class=policytext>
<p><b>Last updated: September 2020</b></p>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to St. Raphaela's Secondary School, Upp Kilmacud Road, Stillorgan, Co. Dublin.</p>
          </li>
...
<hr>
 ...
 <div class="image2">
            <img alt="Privacy Policy" src="../assets/privacy.jpg">
  </div>
...
<div class="image3">
            <img alt="Privacy Policy" src="../assets/privacy_lock.png">
  </div>
<div class=policytext>
...
<div class="image4">
            <img alt="Contact Us" src="../assets/contact_icon.png">
</div>
</ol>
</div>
</div>
